package top.andro.a_palette.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.WHITE_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.WHITE_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.WHITE_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.GRAY_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.GRAY_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.GRAY_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.BLACK_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.BLACK_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.BLACK_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.BROWN_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.BROWN_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.BROWN_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.RED_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.RED_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.RED_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.ORANGE_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.ORANGE_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.ORANGE_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.YELLOW_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.YELLOW_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.YELLOW_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.LIME_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.LIME_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.LIME_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.GREEN_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.GREEN_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.GREEN_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.CYAN_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.CYAN_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.CYAN_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.BLUE_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.BLUE_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.BLUE_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.PURPLE_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.PURPLE_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.PURPLE_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.MAGENTA_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.MAGENTA_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.MAGENTA_STAINED_WOODEN_BUTTON.get());
        ...
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_STAIRS.get());
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_SLAB.get());
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_FENCE.get());
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_FENCE_GATE.get());
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_PRESSURE_PLATE.get());
        this.add(ModBlocks.PINK_STAINED_WOODEN_DOOR.get(), block -> createDoorTable(ModBlocks.PINK_STAINED_WOODEN_DOOR.get()));
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_TRAPDOOR.get());
        this.dropSelf(ModBlocks.PINK_STAINED_WOODEN_BUTTON.get());
