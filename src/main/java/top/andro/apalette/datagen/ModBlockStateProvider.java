...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.WHITE_STAINED_PLANK_DOOR.get(), modLoc("block/white_stained_plank_door_bottom"), modLoc("block/white_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.WHITE_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/white_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.LIGHT_GRAY_STAINED_PLANK_DOOR.get(), modLoc("block/light_gray_stained_plank_door_bottom"), modLoc("block/light_gray_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.LIGHT_GRAY_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/light_gray_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.GRAY_STAINED_PLANK_DOOR.get(), modLoc("block/gray_stained_plank_door_bottom"), modLoc("block/gray_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.GRAY_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/gray_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.BLACK_STAINED_PLANK_DOOR.get(), modLoc("block/black_stained_plank_door_bottom"), modLoc("block/black_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.BLACK_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/black_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.BROWN_STAINED_PLANK_DOOR.get(), modLoc("block/brown_stained_plank_door_bottom"), modLoc("block/brown_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.BROWN_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/brown_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.RED_STAINED_PLANK_DOOR.get(), modLoc("block/red_stained_plank_door_bottom"), modLoc("block/red_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.RED_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/red_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.ORANGE_STAINED_PLANK_DOOR.get(), modLoc("block/orange_stained_plank_door_bottom"), modLoc("block/orange_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.ORANGE_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/orange_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.YELLOW_STAINED_PLANK_DOOR.get(), modLoc("block/yellow_stained_plank_door_bottom"), modLoc("block/yellow_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.YELLOW_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/yellow_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.LIME_STAINED_PLANK_DOOR.get(), modLoc("block/lime_stained_plank_door_bottom"), modLoc("block/lime_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.LIME_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/lime_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.GREEN_STAINED_PLANK_DOOR.get(), modLoc("block/green_stained_plank_door_bottom"), modLoc("block/green_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.GREEN_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/green_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.CYAN_STAINED_PLANK_DOOR.get(), modLoc("block/cyan_stained_plank_door_bottom"), modLoc("block/cyan_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.CYAN_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/cyan_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.LIGHT_BLUE_STAINED_PLANK_DOOR.get(), modLoc("block/light_blue_stained_plank_door_bottom"), modLoc("block/light_blue_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.LIGHT_BLUE_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/light_blue_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.BLUE_STAINED_PLANK_DOOR.get(), modLoc("block/blue_stained_plank_door_bottom"), modLoc("block/blue_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.BLUE_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/blue_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.PURPLE_STAINED_PLANK_DOOR.get(), modLoc("block/purple_stained_plank_door_bottom"), modLoc("block/purple_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.PURPLE_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/purple_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.MAGENTA_STAINED_PLANK_DOOR.get(), modLoc("block/magenta_stained_plank_door_bottom"), modLoc("block/magenta_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.MAGENTA_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/magenta_stained_plank_trapdoor"), true, "cutout");
        ...
        doorBlockWithRenderType((DoorBlock)ModBlocks.PINK_STAINED_PLANK_DOOR.get(), modLoc("block/pink_stained_plank_door_bottom"), modLoc("block/pink_stained_plank_door_top"), "cutout");
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.PINK_STAINED_PLANK_TRAPDOOR.get(), modLoc("block/pink_stained_plank_trapdoor"), true, "cutout");

        buttonBlock((ButtonBlock) ModBlocks.WHITE_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.WHITE_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.LIGHT_GRAY_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.LIGHT_GRAY_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.GRAY_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.GRAY_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.BLACK_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.BLACK_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.BROWN_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.BROWN_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.RED_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.RED_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.ORANGE_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.ORANGE_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.YELLOW_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.YELLOW_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.LIME_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.LIME_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.GREEN_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.GREEN_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.CYAN_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.CYAN_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.LIGHT_BLUE_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.LIGHT_BLUE_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.BLUE_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.BLUE_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.PURPLE_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.PURPLE_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.MAGENTA_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.MAGENTA_STAINED_PLANKS.get()));
        buttonBlock((ButtonBlock) ModBlocks.PINK_STAINED_PLANK_BUTTON.get(), blockTexture(ModBlocks.PINK_STAINED_PLANKS.get()));

        pressurePlateBlock((PressurePlateBlock) ModBlocks.WHITE_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.WHITE_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.LIGHT_GRAY_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.LIGHT_GRAY_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.GRAY_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.GRAY_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.BLACK_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.BLACK_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.BROWN_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.BROWN_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.RED_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.RED_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.ORANGE_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.ORANGE_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.YELLOW_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.YELLOW_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.LIME_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.LIME_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.GREEN_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.GREEN_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.CYAN_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.CYAN_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.LIGHT_BLUE_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.LIGHT_BLUE_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.BLUE_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.BLUE_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.PURPLE_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.PURPLE_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.MAGENTA_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.MAGENTA_STAINED_PLANKS.get()));
        pressurePlateBlock((PressurePlateBlock) ModBlocks.PINK_STAINED_PLANK_PRESSURE_PLATE.get(), blockTexture(ModBlocks.PINK_STAINED_PLANKS.get()));
        ...
        blockItem(ModBlocks.WHITE_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.LIGHT_GRAY_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.GRAY_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.BLACK_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.BROWN_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.RED_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.ORANGE_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.YELLOW_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.LIME_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.GREEN_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.CYAN_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.LIGHT_BLUE_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.BLUE_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.PURPLE_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.MAGENTA_STAINED_PLANK_PRESSURE_PLATE);
        blockItem(ModBlocks.PINK_STAINED_PLANK_PRESSURE_PLATE);

        blockItem(ModBlocks.WHITE_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.LIGHT_GRAY_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.GRAY_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.BLACK_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.BROWN_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.RED_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.ORANGE_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.YELLOW_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.LIME_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.GREEN_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.CYAN_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.LIGHT_BLUE_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.BLUE_STAINED_PLANK_TRAPDOOR);
        blockItem(ModBlocks.PURPLE_STAINED_PLANK_TRAPDOOR);
