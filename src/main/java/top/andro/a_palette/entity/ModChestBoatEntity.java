...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public Item getDropItem() {
        return switch (getModVariant()) {
            case WHITE -> ModItems.WHITE_STAINED_WOODEN_CHEST_BOAT.get();
            case LIGHT_GRAY -> ModItems.LIGHT_GRAY_STAINED_WOODEN_CHEST_BOAT.get();
            case GRAY -> ModItems.GRAY_STAINED_WOODEN_CHEST_BOAT.get();
            case BLACK -> ModItems.BLACK_STAINED_WOODEN_CHEST_BOAT.get();
            case BROWN -> ModItems.BROWN_STAINED_WOODEN_CHEST_BOAT.get();
            case RED -> ModItems.RED_STAINED_WOODEN_CHEST_BOAT.get();
            case ORANGE -> ModItems.ORANGE_STAINED_WOODEN_CHEST_BOAT.get();
            case YELLOW -> ModItems.YELLOW_STAINED_WOODEN_CHEST_BOAT.get();
            case LIME -> ModItems.LIME_STAINED_WOODEN_CHEST_BOAT.get();
            case GREEN -> ModItems.GREEN_STAINED_WOODEN_CHEST_BOAT.get();
            case CYAN -> ModItems.CYAN_STAINED_WOODEN_CHEST_BOAT.get();
            case LIGHT_BLUE -> ModItems.LIGHT_BLUE_STAINED_WOODEN_CHEST_BOAT.get();
            case BLUE -> ModItems.BLUE_STAINED_WOODEN_CHEST_BOAT.get();
            case PURPLE -> ModItems.PURPLE_STAINED_WOODEN_CHEST_BOAT.get();
            case MAGENTA -> ModItems.MAGENTA_STAINED_WOODEN_CHEST_BOAT.get();
            case PINK -> ModItems.PINK_STAINED_WOODEN_CHEST_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(DATA_ID_TYPE, ModBoatEntity.Type.WHITE.ordinal());
    }
