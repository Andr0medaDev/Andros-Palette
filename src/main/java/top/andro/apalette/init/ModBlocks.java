...
/*
    //LOGS
    public static final RegistryObject<Block> WHITE_STAINED_LOG = registerBlock("white_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> LIGHT_GRAY_STAINED_LOG = registerBlock("light_gray_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> GRAY_STAINED_LOG = registerBlock("gray_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> BLACK_STAINED_LOG = registerBlock("black_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> BROWN_STAINED_LOG = registerBlock("brown_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> RED_STAINED_LOG = registerBlock("red_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> ORANGE_STAINED_LOG = registerBlock("orange_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> YELLOW_STAINED_LOG = registerBlock("yellow_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> LIME_STAINED_LOG = registerBlock("lime_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> GREEN_STAINED_LOG = registerBlock("green_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> CYAN_STAINED_LOG = registerBlock("cyan_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> LIGHT_BLUE_STAINED_LOG = registerBlock("light_blue_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> BLUE_STAINED_LOG = registerBlock("blue_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> PURPLE_STAINED_LOG = registerBlock("purple_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> MAGENTA_STAINED_LOG = registerBlock("magenta_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> PINK_STAINED_LOG = registerBlock("pink_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));


    //STRIPPED LOGS
    public static final RegistryObject<Block> STRIPPED_WHITE_STAINED_LOG = registerBlock("stripped_white_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_LIGHT_GRAY_STAINED_LOG = registerBlock("stripped_light_gray_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_GRAY_STAINED_LOG = registerBlock("stripped_gray_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_BLACK_STAINED_LOG = registerBlock("stripped_black_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_BROWN_STAINED_LOG = registerBlock("stripped_brown_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_RED_STAINED_LOG = registerBlock("stripped_red_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_ORANGE_STAINED_LOG = registerBlock("stripped_orange_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_YELLOW_STAINED_LOG = registerBlock("stripped_yellow_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_LIME_STAINED_LOG = registerBlock("stripped_lime_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_GREEN_STAINED_LOG = registerBlock("stripped_green_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_CYAN_STAINED_LOG = registerBlock("stripped_cyan_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_LIGHT_BLUE_STAINED_LOG = registerBlock("stripped_light_blue_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_BLUE_STAINED_LOG = registerBlock("stripped_blue_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_PURPLE_STAINED_LOG = registerBlock("stripped_purple_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_MAGENTA_STAINED_LOG = registerBlock("stripped_magenta_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
    public static final RegistryObject<Block> STRIPPED_PINK_STAINED_LOG = registerBlock("stripped_pink_stained_log", () -> new Block(BlockBehaviour.Properties.copy(Blocks.OAK_LOG)));
*/
