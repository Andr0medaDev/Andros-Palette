...
public class ModItems {
    ...
    public static final DeferredItem<Item> WHITE_STAINED_BOAT = ITEMS.register("white_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.WHITE, new Item.Properties()));
    public static final DeferredItem<Item> LIGHT_GRAY_STAINED_BOAT = ITEMS.register("light_gray_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.LIGHT_GRAY, new Item.Properties()));
    public static final DeferredItem<Item> GRAY_STAINED_BOAT = ITEMS.register("gray_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.GRAY, new Item.Properties()));
    public static final DeferredItem<Item> BLACK_STAINED_BOAT = ITEMS.register("black_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.BLACK, new Item.Properties()));
    public static final DeferredItem<Item> BROWN_STAINED_BOAT = ITEMS.register("brown_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.BROWN, new Item.Properties()));
    public static final DeferredItem<Item> RED_STAINED_BOAT = ITEMS.register("red_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.RED, new Item.Properties()));
    public static final DeferredItem<Item> ORANGE_STAINED_BOAT = ITEMS.register("orange_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.ORANGE, new Item.Properties()));
    public static final DeferredItem<Item> YELLOW_STAINED_BOAT = ITEMS.register("yellow_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.YELLOW, new Item.Properties()));
    public static final DeferredItem<Item> LIME_STAINED_BOAT = ITEMS.register("lime_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.LIME, new Item.Properties()));
    public static final DeferredItem<Item> GREEN_STAINED_BOAT = ITEMS.register("green_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.GREEN, new Item.Properties()));
    public static final DeferredItem<Item> CYAN_STAINED_BOAT = ITEMS.register("cyan_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.CYAN, new Item.Properties()));
    public static final DeferredItem<Item> LIGHT_BLUE_STAINED_BOAT = ITEMS.register("light_blue_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.LIGHT_BLUE, new Item.Properties()));
    public static final DeferredItem<Item> BLUE_STAINED_BOAT = ITEMS.register("blue_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.BLUE, new Item.Properties()));
    public static final DeferredItem<Item> PURPLE_STAINED_BOAT = ITEMS.register("purple_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.PURPLE, new Item.Properties()));
    public static final DeferredItem<Item> MAGENTA_STAINED_BOAT = ITEMS.register("magenta_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.MAGENTA, new Item.Properties()));
    public static final DeferredItem<Item> PINK_STAINED_BOAT = ITEMS.register("pink_stained_boat", () -> new ModBoatItem(false, ModBoatEntity.Type.PINK, new Item.Properties()));

    public static final DeferredItem<Item> WHITE_STAINED_CHEST_BOAT = ITEMS.register("white_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.WHITE, new Item.Properties()));
    public static final DeferredItem<Item> LIGHT_GRAY_STAINED_CHEST_BOAT = ITEMS.register("light_gray_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.LIGHT_GRAY, new Item.Properties()));
    public static final DeferredItem<Item> GRAY_STAINED_CHEST_BOAT = ITEMS.register("gray_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.GRAY, new Item.Properties()));
    public static final DeferredItem<Item> BLACK_STAINED_CHEST_BOAT = ITEMS.register("black_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.BLACK, new Item.Properties()));
    public static final DeferredItem<Item> BROWN_STAINED_CHEST_BOAT = ITEMS.register("brown_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.BROWN, new Item.Properties()));
    public static final DeferredItem<Item> RED_STAINED_CHEST_BOAT = ITEMS.register("red_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.RED, new Item.Properties()));
    public static final DeferredItem<Item> ORANGE_STAINED_CHEST_BOAT = ITEMS.register("orange_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.ORANGE, new Item.Properties()));
    public static final DeferredItem<Item> YELLOW_STAINED_CHEST_BOAT = ITEMS.register("yellow_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.YELLOW, new Item.Properties()));
    public static final DeferredItem<Item> LIME_STAINED_CHEST_BOAT = ITEMS.register("lime_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.LIME, new Item.Properties()));
    public static final DeferredItem<Item> GREEN_STAINED_CHEST_BOAT = ITEMS.register("green_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.GREEN, new Item.Properties()));
    public static final DeferredItem<Item> CYAN_STAINED_CHEST_BOAT = ITEMS.register("cyan_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.CYAN, new Item.Properties()));
    public static final DeferredItem<Item> LIGHT_BLUE_STAINED_CHEST_BOAT = ITEMS.register("light_blue_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.LIGHT_BLUE, new Item.Properties()));
    public static final DeferredItem<Item> BLUE_STAINED_CHEST_BOAT = ITEMS.register("blue_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.BLUE, new Item.Properties()));
    public static final DeferredItem<Item> PURPLE_STAINED_CHEST_BOAT = ITEMS.register("purple_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.PURPLE, new Item.Properties()));
    public static final DeferredItem<Item> MAGENTA_STAINED_CHEST_BOAT = ITEMS.register("magenta_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.MAGENTA, new Item.Properties()));
    public static final DeferredItem<Item> PINK_STAINED_CHEST_BOAT = ITEMS.register("pink_stained_chest_boat", () -> new ModBoatItem(true, ModBoatEntity.Type.PINK, new Item.Properties()));
