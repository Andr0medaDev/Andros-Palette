...
public class ModBlocks {
    ...
    //LOGS
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_LOG = registerBlock("white_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_LOG = registerBlock("light_gray_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_LOG = registerBlock("gray_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_LOG = registerBlock("black_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_LOG = registerBlock("brown_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_LOG = registerBlock("red_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_LOG = registerBlock("orange_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_LOG = registerBlock("yellow_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_LOG = registerBlock("lime_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_LOG = registerBlock("green_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_LOG = registerBlock("cyan_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_LOG = registerBlock("light_blue_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_LOG = registerBlock("blue_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_LOG = registerBlock("purple_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_LOG = registerBlock("magenta_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_LOG = registerBlock("pink_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));


    //STRIPPED LOGS
    public static final DeferredBlock<Block> STRIPPED_WHITE_STAINED_WOODEN_LOG = registerBlock("stripped_white_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_LIGHT_GRAY_STAINED_WOODEN_LOG = registerBlock("stripped_light_gray_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_GRAY_STAINED_WOODEN_LOG = registerBlock("stripped_gray_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_BLACK_STAINED_WOODEN_LOG = registerBlock("stripped_black_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_BROWN_STAINED_WOODEN_LOG = registerBlock("stripped_brown_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_RED_STAINED_WOODEN_LOG = registerBlock("stripped_red_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_ORANGE_STAINED_WOODEN_LOG = registerBlock("stripped_orange_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_YELLOW_STAINED_WOODEN_LOG = registerBlock("stripped_yellow_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_LIME_STAINED_WOODEN_LOG = registerBlock("stripped_lime_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_GREEN_STAINED_WOODEN_LOG = registerBlock("stripped_green_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_CYAN_STAINED_WOODEN_LOG = registerBlock("stripped_cyan_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_LIGHT_BLUE_STAINED_WOODEN_LOG = registerBlock("stripped_light_blue_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_BLUE_STAINED_WOODEN_LOG = registerBlock("stripped_blue_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_PURPLE_STAINED_WOODEN_LOG = registerBlock("stripped_purple_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_MAGENTA_STAINED_WOODEN_LOG = registerBlock("stripped_magenta_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_LOG)));
    public static final DeferredBlock<Block> STRIPPED_PINK_STAINED_WOODEN_LOG = registerBlock("stripped_pink_stained_wooden_log", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LOG)));


    //WOOD
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_WOOD = registerBlock("white_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_WOOD = registerBlock("light_gray_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_WOOD = registerBlock("gray_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_WOOD = registerBlock("black_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_WOOD = registerBlock("brown_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_WOOD = registerBlock("red_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_WOOD = registerBlock("orange_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_WOOD = registerBlock("yellow_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_WOOD = registerBlock("lime_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_WOOD = registerBlock("green_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_WOOD = registerBlock("cyan_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_WOOD = registerBlock("light_blue_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_WOOD = registerBlock("blue_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_WOOD = registerBlock("purple_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_WOOD = registerBlock("magenta_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_WOOD = registerBlock("pink_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WOOD)));


    //STRIPPED WOOD
    public static final DeferredBlock<Block> STRIPPED_WHITE_STAINED_WOODEN_WOOD = registerBlock("stripped_white_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_LIGHT_GRAY_STAINED_WOODEN_WOOD = registerBlock("stripped_light_gray_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_GRAY_STAINED_WOODEN_WOOD = registerBlock("stripped_gray_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_BLACK_STAINED_WOODEN_WOOD = registerBlock("stripped_black_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_BROWN_STAINED_WOODEN_WOOD = registerBlock("stripped_brown_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_RED_STAINED_WOODEN_WOOD = registerBlock("stripped_red_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_ORANGE_STAINED_WOODEN_WOOD = registerBlock("stripped_orange_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_YELLOW_STAINED_WOODEN_WOOD = registerBlock("stripped_yellow_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_LIME_STAINED_WOODEN_WOOD = registerBlock("stripped_lime_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_GREEN_STAINED_WOODEN_WOOD = registerBlock("stripped_green_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_CYAN_STAINED_WOODEN_WOOD = registerBlock("stripped_cyan_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_LIGHT_BLUE_STAINED_WOODEN_WOOD = registerBlock("stripped_light_blue_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_BLUE_STAINED_WOODEN_WOOD = registerBlock("stripped_blue_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_PURPLE_STAINED_WOODEN_WOOD = registerBlock("stripped_purple_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_MAGENTA_STAINED_WOODEN_WOOD = registerBlock("stripped_magenta_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));
    public static final DeferredBlock<Block> STRIPPED_PINK_STAINED_WOODEN_WOOD = registerBlock("stripped_pink_stained_wooden_wood", () -> new ModFlammableRotatedPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STRIPPED_OAK_WOOD)));


    //PLANKS
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_PLANKS = registerBlock("white_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_PLANKS = registerBlock("light_gray_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_PLANKS = registerBlock("gray_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_PLANKS = registerBlock("black_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_PLANKS = registerBlock("brown_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_PLANKS = registerBlock("red_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_PLANKS = registerBlock("orange_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_PLANKS = registerBlock("yellow_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_PLANKS = registerBlock("lime_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_PLANKS = registerBlock("green_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_PLANKS = registerBlock("cyan_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_PLANKS = registerBlock("light_blue_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_PLANKS = registerBlock("blue_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_PLANKS = registerBlock("purple_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_PLANKS = registerBlock("magenta_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_PLANKS = registerBlock("pink_stained_wooden_planks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));


    //PLANK STAIRS
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_STAIRS = registerBlock("white_stained_wooden_stairs", () -> new StairBlock(ModBlocks.WHITE_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_STAIRS = registerBlock("light_gray_stained_wooden_stairs", () -> new StairBlock(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_STAIRS = registerBlock("gray_stained_wooden_stairs", () -> new StairBlock(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_STAIRS = registerBlock("black_stained_wooden_stairs", () -> new StairBlock(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_STAIRS = registerBlock("brown_stained_wooden_stairs", () -> new StairBlock(ModBlocks.BROWN_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_STAIRS = registerBlock("red_stained_wooden_stairs", () -> new StairBlock(ModBlocks.RED_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_STAIRS = registerBlock("orange_stained_wooden_stairs", () -> new StairBlock(ModBlocks.ORANGE_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_STAIRS = registerBlock("yellow_stained_wooden_stairs", () -> new StairBlock(ModBlocks.YELLOW_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_STAIRS = registerBlock("lime_stained_wooden_stairs", () -> new StairBlock(ModBlocks.LIME_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_STAIRS = registerBlock("green_stained_wooden_stairs", () -> new StairBlock(ModBlocks.GREEN_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_STAIRS = registerBlock("cyan_stained_wooden_stairs", () -> new StairBlock(ModBlocks.CYAN_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_STAIRS = registerBlock("light_blue_stained_wooden_stairs", () -> new StairBlock(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_STAIRS = registerBlock("blue_stained_wooden_stairs", () -> new StairBlock(ModBlocks.BLUE_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_STAIRS = registerBlock("purple_stained_wooden_stairs", () -> new StairBlock(ModBlocks.PURPLE_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_STAIRS = registerBlock("magenta_stained_wooden_stairs", () -> new StairBlock(ModBlocks.MAGENTA_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_STAIRS = registerBlock("pink_stained_wooden_stairs", () -> new StairBlock(ModBlocks.PINK_STAINED_WOODEN_PLANKS.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(OAK_PLANKS)));


    //PLANK SLABS
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_SLAB = registerBlock("white_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.WHITE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_SLAB = registerBlock("light_gray_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_SLAB = registerBlock("gray_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_SLAB = registerBlock("black_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLACK_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_SLAB = registerBlock("brown_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BROWN_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_SLAB = registerBlock("red_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.RED_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_SLAB = registerBlock("orange_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.ORANGE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_SLAB = registerBlock("yellow_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.YELLOW_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_SLAB = registerBlock("lime_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIME_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_SLAB = registerBlock("green_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.GREEN_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_SLAB = registerBlock("cyan_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.CYAN_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_SLAB = registerBlock("light_blue_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_SLAB = registerBlock("blue_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLUE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_SLAB = registerBlock("purple_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.PURPLE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_SLAB = registerBlock("magenta_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.MAGENTA_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_SLAB = registerBlock("pink_stained_wooden_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.PINK_STAINED_WOODEN_PLANKS.get())));


    //PLANK FENCES
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_FENCE = registerBlock("white_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.WHITE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_FENCE = registerBlock("light_gray_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_FENCE = registerBlock("gray_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_FENCE = registerBlock("black_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLACK_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_FENCE = registerBlock("brown_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BROWN_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_FENCE = registerBlock("red_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.RED_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_FENCE = registerBlock("orange_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.ORANGE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_FENCE = registerBlock("yellow_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.YELLOW_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_FENCE = registerBlock("lime_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIME_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_FENCE = registerBlock("green_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.GREEN_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_FENCE = registerBlock("cyan_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.CYAN_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_FENCE = registerBlock("light_blue_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_FENCE = registerBlock("blue_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLUE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_FENCE = registerBlock("purple_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.PURPLE_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_FENCE = registerBlock("magenta_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.MAGENTA_STAINED_WOODEN_PLANKS.get())));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_FENCE = registerBlock("pink_stained_wooden_fence", () -> new FenceBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.PINK_STAINED_WOODEN_PLANKS.get())));


    //PLANK FENCE GATES
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_FENCE_GATE = registerBlock("white_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.WHITE_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_FENCE_GATE = registerBlock("light_gray_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_FENCE_GATE = registerBlock("gray_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_FENCE_GATE = registerBlock("black_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLACK_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_FENCE_GATE = registerBlock("brown_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BROWN_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_FENCE_GATE = registerBlock("red_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.RED_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_FENCE_GATE = registerBlock("orange_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.ORANGE_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_FENCE_GATE = registerBlock("yellow_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.YELLOW_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_FENCE_GATE = registerBlock("lime_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIME_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_FENCE_GATE = registerBlock("green_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.GREEN_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_FENCE_GATE = registerBlock("cyan_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.CYAN_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_FENCE_GATE = registerBlock("light_blue_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_FENCE_GATE = registerBlock("blue_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLUE_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_FENCE_GATE = registerBlock("purple_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.PURPLE_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_FENCE_GATE = registerBlock("magenta_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.MAGENTA_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_FENCE_GATE = registerBlock("pink_stained_wooden_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.ofFullCopy(ModBlocks.PINK_STAINED_WOODEN_PLANKS.get()), SoundEvents.FENCE_GATE_OPEN, SoundEvents.FENCE_GATE_CLOSE));
    ...
    //PRESSURE PLATES
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("white_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.WHITE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("light_gray_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("gray_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("black_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLACK_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("brown_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.BROWN_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("red_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.RED_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("orange_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.ORANGE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("yellow_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.YELLOW_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("lime_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIME_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("green_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.GREEN_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("cyan_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.CYAN_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("light_blue_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("blue_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLUE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("purple_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.PURPLE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("magenta_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.MAGENTA_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_PRESSURE_PLATE = registerBlock("pink_stained_wooden_pressure_plate", () -> new PressurePlateBlock(BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(ModBlocks.PINK_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));

    //BUTTONS
    public static final DeferredBlock<Block> WHITE_STAINED_WOODEN_BUTTON = registerBlock("white_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.WHITE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> LIGHT_GRAY_STAINED_WOODEN_BUTTON = registerBlock("light_gray_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_GRAY_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> GRAY_STAINED_WOODEN_BUTTON = registerBlock("gray_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.GRAY_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> BLACK_STAINED_WOODEN_BUTTON = registerBlock("black_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLACK_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> BROWN_STAINED_WOODEN_BUTTON = registerBlock("brown_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.BROWN_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> RED_STAINED_WOODEN_BUTTON = registerBlock("red_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.RED_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> ORANGE_STAINED_WOODEN_BUTTON = registerBlock("orange_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.ORANGE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> YELLOW_STAINED_WOODEN_BUTTON = registerBlock("yellow_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.YELLOW_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> LIME_STAINED_WOODEN_BUTTON = registerBlock("lime_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIME_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> GREEN_STAINED_WOODEN_BUTTON = registerBlock("green_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.GREEN_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> CYAN_STAINED_WOODEN_BUTTON = registerBlock("cyan_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.CYAN_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> LIGHT_BLUE_STAINED_WOODEN_BUTTON = registerBlock("light_blue_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.LIGHT_BLUE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> BLUE_STAINED_WOODEN_BUTTON = registerBlock("blue_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.BLUE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> PURPLE_STAINED_WOODEN_BUTTON = registerBlock("purple_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.PURPLE_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> MAGENTA_STAINED_WOODEN_BUTTON = registerBlock("magenta_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.MAGENTA_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
    public static final DeferredBlock<Block> PINK_STAINED_WOODEN_BUTTON = registerBlock("pink_stained_wooden_button", () -> new ButtonBlock(BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(ModBlocks.PINK_STAINED_WOODEN_PLANKS.get()).sound(SoundType.WOOD)));
