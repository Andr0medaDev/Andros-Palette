...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_WHITE_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_WHITE_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_white_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_LIGHT_GRAY_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_LIGHT_GRAY_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_light_gray_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_GRAY_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_GRAY_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_gray_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_BLACK_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_BLACK_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_black_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_BROWN_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_BROWN_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_brown_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_RED_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_RED_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_red_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_ORANGE_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_ORANGE_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_orange_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_YELLOW_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_YELLOW_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_yellow_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_LIME_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_LIME_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_lime_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_GREEN_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_GREEN_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_green_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_CYAN_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_CYAN_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_cyan_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_LIGHT_BLUE_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_LIGHT_BLUE_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_light_blue_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_BLUE_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_BLUE_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_blue_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_PURPLE_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_PURPLE_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_purple_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_MAGENTA_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_MAGENTA_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_magenta_stained_log_top"));
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_PINK_STAINED_LOG.get()), blockTexture(ModBlocks.STRIPPED_PINK_STAINED_LOG.get()), ResourceLocation.fromNamespaceAndPath(APalette.MOD_ID, "block/stripped_pink_stained_log_top"));
